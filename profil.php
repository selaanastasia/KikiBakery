...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    // Jika tidak ditemukan, Anda bisa mengatur nilai default atau menangani kesalahan
...
<div class="container py-3">
  <header>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      <h1 class="display-4 fw-normal text-body-emphasis">Welcome <?php echo $nama; ?>!</h1>
      <p class="fs-5 text-body-secondary">Thank you for registrasion! Get discount for you first order!</p>
    </div>
  </header>
  ...
  <div class="card mb-4 rounded-3 shadow-sm border-primary">
    <div class="card-header py-3 text-bg-primary border-primary">
      <h4 class="my-0 fw-normal">User Profile</h4>
    </div>
    <div class="card-body">
      <table class="table">
        <thead>
        ...
        <tbody>
          <tr>
            ...
            <a href="index.php"><button type="button" class="w-100 btn btn-lg btn-primary">Back to Shop!</button></a>
          </div>
        </div>
      </div>
    </div>
